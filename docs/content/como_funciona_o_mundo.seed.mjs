...
const LEITE = [
  ...
  N('o_leite', { gl: 'O leite', es: 'La leche', en: 'Milk' },
    ...
    { gl: 'O leite é sobre todo auga con graxa, proteínas e un azucre chamado lactosa. Se se deixa quieto, a graxa sobe e forma a nata. A pasteurización, que quenta o leite a uns 72 graos uns segundos, inventouna Louis Pasteur para que non nos puxese enfermos.',
      es: 'La leche es sobre todo agua con grasa, proteínas y un azúcar llamado lactosa. Si se deja quieta, la grasa sube y forma la nata. La pasteurización, que calienta la leche a unos 72 grados unos segundos, la inventó Louis Pasteur para que no nos pusiera enfermos.',
      en: 'Milk is mostly water with fat, proteins and a sugar called lactose. If left still, the fat rises and forms cream. Pasteurisation, which heats milk to about 72 degrees for a few seconds, was invented by Louis Pasteur so it would not make us ill.' },
