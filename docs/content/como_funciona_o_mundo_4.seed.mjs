...
const MOVIL = [
  ...
  N('o_cable_submarino', { gl: 'O cable submarino', es: 'El cable submarino', en: 'The undersea cable' },
    ...
    { gl: 'Hai máis dun millón de quilómetros de cables submarinos no mundo. Un dos primeiros cables telegráficos entre Europa e América, en 1866, tardaba minutos en mandar unha palabra; hoxe un cable de fibra move billóns de uns e ceros por segundo. En Galicia hai cables que saen do mar en Sada.',
      es: 'Hay más de un millón de kilómetros de cables submarinos en el mundo. Uno de los primeros cables telegráficos entre Europa y América, en 1866, tardaba minutos en mandar una palabra; hoy un cable de fibra mueve billones de unos y ceros por segundo. En Galicia hay cables que salen del mar en Sada.',
      en: 'There are more than a million kilometres of undersea cables in the world. One of the first telegraph cables between Europe and America, in 1866, took minutes to send one word; today a fibre cable moves trillions of ones and zeros per second. In Galicia, cables come ashore at Sada.' },
