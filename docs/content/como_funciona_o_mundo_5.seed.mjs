...
const CORPO = [
  ...
  N('o_intestino', { gl: 'O intestino', es: 'El intestino', en: 'The intestine' },
    ...
    { gl: 'As pregas do intestino chámanse vilosidades; estiradas, cubrirían unha pista de tenis. No intestino viven billóns de bacterias boas que axudan a dixerir e fabrican vitaminas: é o microbioma. Comer froita, verdura e legumes é alimentalas a elas tamén.',
      es: 'Los pliegues del intestino se llaman vellosidades; estiradas, cubrirían una pista de tenis. En el intestino viven billones de bacterias buenas que ayudan a digerir y fabrican vitaminas: es el microbioma. Comer fruta, verdura y legumbres es alimentarlas a ellas también.',
      en: 'The folds of the intestine are called villi; stretched out, they would cover a tennis court. Trillions of good bacteria live in the intestine, helping digestion and making vitamins: the microbiome. Eating fruit, vegetables and pulses feeds them too.' },
