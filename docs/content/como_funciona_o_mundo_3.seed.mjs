...
const SAL = [
  ...
  N('o_sal', { gl: 'O sal', es: 'La sal', en: 'Salt' },
    ...
    { gl: 'A palabra "salario" vén do sal: aos soldados romanos pagábanlles unha parte en sal, tan valioso era. O corpo precisa un pouco de sal para funcionar, pero demasiado fai dano: os médicos recomendan menos de unha cullerada pequena ao día.',
      es: 'La palabra "salario" viene de la sal: a los soldados romanos les pagaban una parte en sal, tan valiosa era. El cuerpo necesita un poco de sal para funcionar, pero demasiada hace daño: los médicos recomiendan menos de una cucharada pequeña al día.',
      en: 'The word "salary" comes from salt: Roman soldiers were paid partly in salt, so valuable was it. The body needs a little salt to work, but too much does harm: doctors recommend less than one small spoonful a day.' },
