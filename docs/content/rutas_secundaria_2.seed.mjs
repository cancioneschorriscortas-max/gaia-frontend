...
const RETOS_SEC = {
  ...
  a_lua_astro: { gl: 'A gravidade da Lúa tira da auga e tamén da terra firme, que sobe uns 30 cm sen que o notemos. Por que a marea se ve tanto no mar e case nada en terra? Fala de que a auga é líquida e pode desprazarse, e de a que distancia está a Lúa.',
