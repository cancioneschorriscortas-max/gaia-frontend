                  ...
                  return (
                    <div key={c.id} aria-label={ten ? (c.titulo[idioma] || c.titulo.gl) : t(idioma, 'cartasOculta')}
                      ...
                      <div style={{ fontSize: 11.5, lineHeight: 1.5, color: ten ? '#c9d6ef' : '#5d6c8f' }}>
                        {ten ? (c.texto[idioma] || c.texto.gl) : t(idioma, c.ruta ? 'cartasComoRuta' : c.evento === 'mision_semana' ? 'cartasComoMision' : c.evento === 'gran_mision' ? 'cartasComoGranMision' : 'cartasComoPortal')}
                      </div>
                    </div>
                  )
                })}
